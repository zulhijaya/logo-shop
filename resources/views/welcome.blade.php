...
<body class="font-inter">
    <section name="header" class="p-5 sm:px-10 md:px-10 lg:px-64 mb-16 md:mb-32">
    ...
    <x-layanan-kami></x-layanan-kami>

    <footer class="text-center py-5 text-sm md:text-base">Hak cipta dilindungi 2021 - Logo Shop</footer>
